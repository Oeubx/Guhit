                      ...
                      children: [
                        AuthUserStreamWidget(
                          builder: (context) => ClipRRect(
                            ...
                            child: Image.network(
                              valueOrDefault(
                                  currentUserDocument?.bgPhotoUrl, ''),
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              ...
                              if (selectedMedia != null &&
                                ...
                                safeSetState(() => _model
                                    .isDataUploading_uploadBgUserImg = true);
                                ...
                                try {
                                  ...
                                  _model.isDataUploading_uploadBgUserImg =
                                      false;
                                }
                                if (selectedUploadedFiles.length ==
                                    ...
                                    downloadUrls.length ==
                                        selectedMedia.length) {
                                  safeSetState(() {
                                    _model.uploadedLocalFile_uploadBgUserImg =
                                        selectedUploadedFiles.first;
                                    _model.uploadedFileUrl_uploadBgUserImg =
                                        downloadUrls.first;
                                  });
                                } else {
                                  safeSetState(() {});
                          ...
                          onTap: () async {
                            ...
                            if (selectedMedia != null &&
                                selectedMedia.every((m) => validateFileFormat(
                                    m.storagePath, context))) {
                              safeSetState(() =>
                                  _model.isDataUploading_uploadData25b = true);
                              var selectedUploadedFiles = <FFUploadedFile>[];
                              ...
                              try {
                                ...
                                _model.isDataUploading_uploadData25b = false;
                              }
                              if (selectedUploadedFiles.length ==
                                      selectedMedia.length &&
                                  downloadUrls.length == selectedMedia.length) {
                                safeSetState(() {
                                  _model.uploadedLocalFile_uploadData25b =
                                      selectedUploadedFiles.first;
                                  _model.uploadedFileUrl_uploadData25b =
                                      downloadUrls.first;
                                });
                              } else {
                                safeSetState(() {});
                  ...
                  FFButtonWidget(
                    onPressed: () async {
                      await currentUserReference!.update(createUsersRecordData(
                        ...
                        photoUrl: _model.uploadedFileUrl_uploadData25b,
                        bgPhotoUrl: _model.uploadedFileUrl_uploadBgUserImg,
