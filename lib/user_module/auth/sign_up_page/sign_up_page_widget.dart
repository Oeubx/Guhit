...
class _SignUpPageWidgetState extends State<SignUpPageWidget> {
  ...
  void initState() {
    ...
    _model.textFieldCpwTextController ??= TextEditingController();
    _model.textFieldCpwFocusNode ??= FocusNode();
  }
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        width: 300.0,
                        child: TextFormField(
                          controller: _model.textFieldCpwTextController,
                          focusNode: _model.textFieldCpwFocusNode,
                          autofocus: false,
                          enabled: true,
                          obscureText: !_model.textFieldCpwVisibility,
                          decoration: InputDecoration(
                            isDense: true,
                            labelStyle: FlutterFlowTheme.of(context)
                                .labelMedium
                          ...
                          cursorColor: FlutterFlowTheme.of(context).primaryText,
                          enableInteractiveSelection: true,
                          validator: _model.textFieldCpwTextControllerValidator
                              .asValidator(context),
                        ),
                      ),
                      FFButtonWidget(
                        onPressed: ((_model.textFieldEmailTextController.text ==
                                        null ||
                                ...
                                (_model.textFieldPwTextController.text ==
                                    ...
                                    _model.textFieldPwTextController.text ==
                                        '') &&
                                (_model.textFieldCpwTextController.text ==
                                        null ||
                                    _model.textFieldCpwTextController.text ==
                                        ''))
                            ? null
                            : () async {
                                ...
                                if (_model.signUpError != null &&
                                  ...
                                  await showDialog(
                                    ...
                                    builder: (alertDialogContext) {
                                      return AlertDialog(
                                        ...
                                        content: Text(_model.signUpError!),
                                        actions: [
                                          TextButton(
                                  ...
                                  context.goNamed(
                                    SignUpVerificationPageWidget.routeName,
                                    queryParameters: {
                        ...
                        options: FFButtonOptions(
                          ...
                          disabledColor: Color(0xFF002D3E),
                        ),
                      ),
                      InkWell(
