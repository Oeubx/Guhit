...
import 'c_approve_changes_ongoing_model.dart';
export 'c_approve_changes_ongoing_model.dart';

class CApproveChangesOngoingWidget extends StatefulWidget {
  const CApproveChangesOngoingWidget({
    super.key,
  ...
  @override
  State<CApproveChangesOngoingWidget> createState() =>
      _CApproveChangesOngoingWidgetState();
}

class _CApproveChangesOngoingWidgetState
    extends State<CApproveChangesOngoingWidget> {
  late CApproveChangesOngoingModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CApproveChangesOngoingModel());
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      ...
                      await NotificationTable().insert({
                        ...
                        'notif_type': 'has approved your commission.',
