...
import 'approve_and_rate_commissioned_model.dart';
export 'approve_and_rate_commissioned_model.dart';

class ApproveAndRateCommissionedWidget extends StatefulWidget {
  const ApproveAndRateCommissionedWidget({
    super.key,
  ...
  @override
  State<ApproveAndRateCommissionedWidget> createState() =>
      _ApproveAndRateCommissionedWidgetState();
}

class _ApproveAndRateCommissionedWidgetState
    extends State<ApproveAndRateCommissionedWidget> {
  late ApproveAndRateCommissionedModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ApproveAndRateCommissionedModel());
                ...
                children: [
                  Align(
                    ...
                    child: Padding(
                      ...
                      child: Text(
                        'We highly value your feedback! Take a moment to rate your experience with the artist!',
                    ...
                    onPressed: () async {
                      await CommissionTable().update(
                        data: {
                          ...
                          'commission_rating': _model.ratingBarValue?.round(),
                        },
                      ...
                      await NotificationTable().insert({
                        ...
                        'made_for': widget!.commissionReference?.commissionedId,
                        'notif_type':
                            'has rated the commission service a ${formatNumber(
