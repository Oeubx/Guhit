...
import 'c_accept_ongoing_model.dart';
export 'c_accept_ongoing_model.dart';

class CAcceptOngoingWidget extends StatefulWidget {
  const CAcceptOngoingWidget({
    super.key,
  ...
  @override
  State<CAcceptOngoingWidget> createState() => _CAcceptOngoingWidgetState();
}

class _CAcceptOngoingWidgetState extends State<CAcceptOngoingWidget> {
  late CAcceptOngoingModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CAcceptOngoingModel());
          ...
          child: Column(
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  Text(
                    'When accepting, the client will be notified that you have taken on the project and work is officially underway.',
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      ...
                      await NotificationTable().insert({
                        ...
                        'notif_type': 'has accepted your commission.',
