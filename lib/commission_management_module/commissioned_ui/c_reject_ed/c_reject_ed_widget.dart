...
import 'c_reject_ed_model.dart';
export 'c_reject_ed_model.dart';

class CRejectEdWidget extends StatefulWidget {
  const CRejectEdWidget({
    super.key,
  ...
  @override
  State<CRejectEdWidget> createState() => _CRejectEdWidgetState();
}

class _CRejectEdWidgetState extends State<CRejectEdWidget> {
  late CRejectEdModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CRejectEdModel());
              ...
              Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Text(
                      'When rejecting, this request will be canceled. You can leave a note for the client below.',
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      ...
                      await NotificationTable().insert({
                        ...
                        'notif_type':
                            'has rejected your requested commission. Remarks : ${_model.textFieldRemarksTextController.text}',
